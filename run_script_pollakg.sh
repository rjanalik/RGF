...
folder_path=/home/x_pollakgr/RGF/data/ns${ns}_nt${nt}
...
CUDA_VISIBLE_DEVICES="0" ./build/bin/main ${folder_path} ${ns} ${nt} ${nb} ${folder_path_data} ${no} >${folder_path}/RGF_output.txt
