...
void fortran_name(daxpy, DAXPY)(int *n, double *da, double *dx, int *incx, double *dy, int *incy);
...
void fortran_name(dgemm, DGEMM)(char *transa, char *transb, int *m, int *n, int *k, double *alpha, double *a, int *lda, double *b,
                                int *ldb, double *beta, double *c, int *ldc);
void fortran_name(dsymm, DSYMM)(char *side, char *uplo, int *m, int *n, double *alpha, double *a, int *lda, double *b, int *ldb,
                                double *beta, double *c, int *ldc);
void fortran_name(dtrsm, DTRSM)(char *side, char *uplo, char *transa, char *diag, int *m, int *n, double *alpha, double *a,
                                int *lda, double *b, int *ldb);
void fortran_name(zgemm, ZGEMM)(char *transa, char *transb, int *m, int *n, int *k, CPX *alpha, CPX *a, int *lda, CPX *b, int *ldb,
                                CPX *beta, CPX *c, int *ldc);
void fortran_name(zsymm, ZSYMM)(char *side, char *uplo, int *m, int *n, CPX *alpha, CPX *a, int *lda, CPX *b, int *ldb, CPX *beta,
                                CPX *c, int *ldc);
void fortran_name(ztrsm, ZTRSM)(char *side, char *uplo, char *transa, char *diag, int *m, int *n, CPX *alpha, CPX *a, int *lda,
                                CPX *b, int *ldb);
void fortran_name(zhemm, ZHEMM)(char *side, char *uplo, int *m, int *n, CPX *alpha, CPX *a, int *lda, CPX *b, int *ldb, CPX *beta,
                                CPX *c, int *ldc);
void fortran_name(dgemv, DGEMV)(char *trans, int *m, int *n, double *alpha, double *a, int *lda, double *x, int *incx, double *beta,
                                double *y, int *incy);

void fortran_name(zgemv, ZGEMV)(char *trans, int *m, int *n, CPX *alpha, CPX *a, int *lda, CPX *x, int *incx, CPX *beta, CPX *y,
                                int *incy);
...
void fortran_name(dgetrs, DGETRS)(char *trans, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, int *info);
void fortran_name(zgetrf, ZGETRF)(int *m, int *n, CPX *a, int *lda, int *ipiv, int *info);
void fortran_name(zgetrs, ZGETRS)(char *trans, int *n, int *nrhs, CPX *a, int *lda, int *ipiv, CPX *b, int *ldb, int *info);
void fortran_name(zgetri, ZGETRI)(int *n, CPX *a, int *lda, int *ipiv, CPX *work, int *lwork, int *info);
void fortran_name(dgeev, DGEEV)(char *jobvl, char *jobvr, int *n, double *a, int *lda, double *wr, double *wi, double *vl,
                                int *ldvl, double *vr, int *ldvr, double *work, int *lwork, int *info);
void fortran_name(dsyev, DSYEV)(char *JOBZ, char *UPLO, int *N, double *A, int *LDA, double *W, double *WORK, int *LWORK,
                                int *INFO);
void fortran_name(dggev, DGGEV)(char *jobvl, char *jobvr, int *n, double *a, int *lda, double *b, int *ldb, double *alphar,
                                double *alphai, double *beta, double *vl, int *ldvl, double *vr, int *ldvr, double *work,
                                int *lwork, int *info);
void fortran_name(zggev, ZGGEV)(char *jobvl, char *jobvr, int *n, CPX *a, int *lda, CPX *b, int *ldb, CPX *alpha, CPX *beta,
                                CPX *vl, int *ldvl, CPX *vr, int *ldvr, CPX *work, int *lwork, double *rwork, int *info);
void fortran_name(zgeev, ZGEEV)(char *jobvl, char *jobvr, int *n, CPX *a, int *lda, CPX *w, CPX *vl, int *ldvl, CPX *vr, int *ldvr,
                                CPX *work, int *lwork, double *rwork, int *info);
void fortran_name(zheev, ZHEEV)(char *jobvl, char *uplo, int *n, CPX *a, int *lda, double *w, CPX *work, int *lwork, double *rwork,
                                int *info);
void fortran_name(dgetri, DGETRI)(int *n, double *a, int *lda, int *ipiv, double *work, int *lwork, int *info);
void fortran_name(dsytri, DSYTRI)(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *info);
void fortran_name(zhetrf, ZHETRF)(char *uplo, int *n, CPX *a, int *lda, int *ipiv, CPX *work, int *lwork, int *info);
void fortran_name(zhetri, ZHETRI)(char *uplo, int *n, CPX *a, int *lda, int *ipiv, CPX *work, int *info);
void fortran_name(zhetrs, ZHETRS)(char *uplo, int *n, int *nrhs, CPX *a, int *lda, int *ipiv, CPX *b, int *ldb, int *info);
void fortran_name(dsysv, DSYSV)(char *uplo, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, double *work,
                                int *lwork, int *info);
void fortran_name(dsytrf, DSYTRF)(char *uplo, int *n, double *a, int *lda, int *ipiv, double *work, int *lwork, int *info);
void fortran_name(dsytrs, DSYTRS)(char *uplo, int *n, int *nrhs, double *a, int *lda, int *ipiv, double *b, int *ldb, int *info);
void fortran_name(dstebz, DSTEBZ)(char *range, char *order, int *iter, double *vl, double *vu, int *il, int *iu, double *abstol,
                                  double *diag, double *offd, int *neval, int *nsplit, double *eval, int *iblock, int *isplit,
                                  double *work, int *iwork, int *info);
void fortran_name(zlarnv, ZLARNV)(int *, int *, int *, CPX *);
void fortran_name(dgesdd, DGESDD)(char *jobz, int *m, int *n, double *a, int *lda, double *s, double *u, int *ldu, double *vt,
                                  int *ldvt, double *work, int *lwork, int *iwork, int *info);
void fortran_name(zgesdd, ZGESDD)(char *jobz, int *m, int *n, CPX *a, int *lda, double *s, CPX *u, int *ldu, CPX *vt, int *ldvt,
                                  CPX *work, int *lwork, double *rwork, int *iwork, int *info);
}

/*SAB********************************************************************************************/

inline double c_dzasum(int n, CPX *dx, int incx) { return fortran_name(dzasum, DZASUM)(&n, dx, &incx); }
...
inline void c_dcopy(int n, double *dx, int incx, double *dy, int incy) { fortran_name(dcopy, DCOPY)(&n, dx, &incx, dy, &incy); }
...
inline double c_dnrm2(int n, double *dx, int incx) { return fortran_name(dnrm2, DNRM2)(&n, dx, &incx); }

/************************************************************************************************/

inline double c_dznrm2(int n, CPX *dx, int incx) { return fortran_name(dznrm2, DZNRM2)(&n, dx, &incx); }

/************************************************************************************************/

inline void c_dscal(int n, double da, double *dx, int incx) { fortran_name(dscal, DSCAL)(&n, &da, dx, &incx); }

/************************************************************************************************/

inline void c_zscal(int n, CPX da, CPX *dx, int incx) { fortran_name(zscal, ZSCAL)(&n, &da, dx, &incx); }

/************************************************************************************************/

inline void c_dgemm(char transa, char transb, int m, int n, int k, double alpha, double *a, int lda, double *b, int ldb,
                    double beta, double *c, int ldc) {
...
inline void c_dsymm(char side, char uplo, int m, int n, double alpha, double *a, int lda, double *b, int ldb, double beta,
                    double *c, int ldc) {
...
inline void c_dtrsm(char side, char uplo, char transa, char diag, int m, int n, double alpha, double *a, int lda, double *b,
                    int ldb) {
...
inline void c_zgemm(char transa, char transb, int m, int n, int k, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c,
                    int ldc) {
...
inline void c_zsymm(char side, char uplo, int m, int n, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c, int ldc) {
...
inline void c_zhemm(char side, char uplo, int m, int n, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c, int ldc) {
    fortran_name(zhemm, ZHEMM)(&side, &uplo, &m, &n, &alpha, a, &lda, b, &ldb, &beta, c, &ldc);
}

/************************************************************************************************/

inline void c_dgemv(char transa, int m, int n, double alpha, double *a, int lda, double *x, int incx, double beta, double *y,
                    int incy) {
...
inline void c_zgemv(char transa, int m, int n, CPX alpha, CPX *a, int lda, CPX *x, int incx, CPX beta, CPX *y, int incy) {
    fortran_name(zgemv, ZGEMV)(&transa, &m, &n, &alpha, a, &lda, x, &incx, &beta, y, &incy);
}

/***********************************************************************************************/
inline double c_ddot(int n, double *x, int incx, double *y, int incy) { return fortran_name(ddot, DDOT)(&n, x, &incx, y, &incy); }
...
inline void c_zcopy(int n, CPX *dx, int incx, CPX *dy, int incy) { fortran_name(zcopy, ZCOPY)(&n, dx, &incx, dy, &incy); }
...
inline double c_dasum(int n, double *dx, int incx) { return fortran_name(dasum, DASUM)(&n, dx, &incx); }
...
template <typename T>
inline void c_tgemm(char transa, char transb, int m, int n, int k, T alpha, T *a, int lda, T *b, int ldb, T beta, T *c, int ldc);

template <>
inline void c_tgemm(char transa, char transb, int m, int n, int k, double alpha, double *a, int lda, double *b, int ldb,
                    double beta, double *c, int ldc) {
    c_dgemm(transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
}

template <>
inline void c_tgemm(char transa, char transb, int m, int n, int k, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c,
                    int ldc) {
...
template <typename T>
inline void c_tsymm(char side, char uplo, int m, int n, T alpha, T *a, int lda, T *b, int ldb, T beta, T *c, int ldc);

template <>
inline void c_tsymm(char side, char uplo, int m, int n, double alpha, double *a, int lda, double *b, int ldb, double beta,
                    double *c, int ldc) {
    c_dsymm(side, uplo, m, n, alpha, a, lda, b, ldb, beta, c, ldc);
}

template <>
inline void c_tsymm(char side, char uplo, int m, int n, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c, int ldc) {
...
template <typename T>
inline void c_ttrsm(char side, char uplo, char transa, char diag, int m, int n, T alpha, T *a, int lda, T *b, int ldb);

template <>
inline void c_ttrsm(char side, char uplo, char transa, char diag, int m, int n, double alpha, double *a, int lda, double *b,
                    int ldb) {
    c_dtrsm(side, uplo, transa, diag, m, n, alpha, a, lda, b, ldb);
}

template <>
inline void c_ttrsm(char side, char uplo, char transa, char diag, int m, int n, CPX alpha, CPX *a, int lda, CPX *b, int ldb) {
...
template <typename T>
inline void tgemm_dev(char transa, char transb, int m, int n, int k, T alpha, T *a, int lda, T *b, int ldb, T beta, T *c, int ldc,
                      magma_queue_t queue);

template <>
inline void tgemm_dev(char transa, char transb, int m, int n, int k, double alpha, double *a, int lda, double *b, int ldb,
...
template <>
inline void tgemm_dev(char transa, char transb, int m, int n, int k, CPX alpha, CPX *a, int lda, CPX *b, int ldb, CPX beta, CPX *c,
                      int ldc, magma_queue_t queue) {
    magma_trans_t magma_transa = magma_trans_const(transa);
    magma_trans_t magma_transb = magma_trans_const(transb);

    // zgemm_on_dev(handle,transa,transb,m,n,k,alpha,a,lda,b,ldb,beta,c,ldc);
    magma_zgemm(magma_transa, magma_transb, m, n, k, *reinterpret_cast<magmaDoubleComplex *>(&alpha), (magmaDoubleComplex_ptr)a,
                lda, (magmaDoubleComplex_ptr)b, ldb, *reinterpret_cast<magmaDoubleComplex *>(&beta), (magmaDoubleComplex_ptr)c, ldc,
                queue);
}
...
template <>
inline void tgetrs_dev(char transa, int n, int nrhs, double *a, int lda, int *ipiv, double *b, int ldb, int *info) {
    magma_trans_t magma_transa = magma_trans_const(transa);
...
template <>
inline void tgetrs_dev(char transa, int n, int nrhs, CPX *a, int lda, int *ipiv, CPX *b, int ldb, int *info) {
    magma_trans_t magma_transa = magma_trans_const(transa);

    magma_zgetrs_gpu(magma_transa, n, nrhs, (magmaDoubleComplex_ptr)a, lda, ipiv, (magmaDoubleComplex_ptr)b, ldb, info);
}
...
inline void tgesv_dev(int n, int nrhs, CPX *a, int lda, int *ipiv, CPX *b, int ldb, int type, int *info) {
    ...
    if (type) {
        magma_zgesv_nopiv_gpu(n, nrhs, (magmaDoubleComplex_ptr)a, lda, (magmaDoubleComplex_ptr)b, ldb, info);
    } else {
        /*
          magma_zgesv_nopiv_gpu(n,nrhs,(magmaDoubleComplex_ptr)a,lda,(magmaDoubleComplex_ptr)b,\
                                ldb,info);
        */
        magma_zhesv_nopiv_gpu(MagmaLower, n, nrhs, (magmaDoubleComplex_ptr)a, lda, (magmaDoubleComplex_ptr)b, ldb, info);
    }
}
...
inline void zgetrs_nopiv_dev(char transa, int n, int nrhs, CPX *a, int lda, CPX *b, int ldb, int *info) {
    ...
    magma_zgetrs_nopiv_gpu(magma_transa, n, nrhs, (magmaDoubleComplex_ptr)a, lda, (magmaDoubleComplex_ptr)b, ldb, info);
}
...
template <typename T>
inline void ttrsm_dev(char side, char uplo, char trans, char diag, int m, int n, T alpha, T *a, int lda, T *b, int ldb,
                      magma_queue_t queue);

template <>
inline void ttrsm_dev(char side, char uplo, char trans, char diag, int m, int n, double alpha, double *a, int lda, double *b,
...
template <>
inline void ttrsm_dev(char side, char uplo, char trans, char diag, int m, int n, CPX alpha, CPX *a, int lda, CPX *b, int ldb,
                      magma_queue_t queue) {
    magma_side_t magma_side = magma_side_const(side);
    magma_uplo_t magma_uplo = magma_uplo_const(uplo);
    magma_trans_t magma_trans = magma_trans_const(trans);
    ...
    magma_ztrsm(magma_side, magma_uplo, magma_trans, magma_diag, m, n, *reinterpret_cast<magmaDoubleComplex *>(&alpha),
                (magmaDoubleComplex_ptr)a, lda, (magmaDoubleComplex_ptr)b, ldb, queue);
}
...
inline void c_dgetrs(char transa, int n, int nrhs, double *a, int lda, int *ipiv, double *b, int ldb, int *info) {
...
inline void c_zgetrs(char transa, int n, int nrhs, CPX *a, int lda, int *ipiv, CPX *b, int ldb, int *info) {
...
inline void c_dgeev(char jobvl, char jobvr, int n, double *a, int lda, double *wr, double *wi, double *vl, int ldvl, double *vr,
...
inline void c_dsyev(char JOBZ, char UPLO, int N, double *A, int LDA, double *W, double *WORK, int LWORK, int *INFO) {
    fortran_name(dsyev, DSYEV)(&JOBZ, &UPLO, &N, A, &LDA, W, WORK, &LWORK, INFO);
}

/************************************************************************************************/

inline void c_dggev(char jobvl, char jobvr, int n, double *a, int lda, double *b, int ldb, double *alphar, double *alphai,
                    double *beta, double *vl, int ldvl, double *vr, int ldvr, double *work, int lwork, int *info) {
    fortran_name(dggev, DGGEV)(&jobvl, &jobvr, &n, a, &lda, b, &ldb, alphar, alphai, beta, vl, &ldvl, vr, &ldvr, work, &lwork,
                               info);
}

/************************************************************************************************/

inline void c_zggev(char jobvl, char jobvr, int n, CPX *a, int lda, CPX *b, int ldb, CPX *alpha, CPX *beta, CPX *vl, int ldvl,
                    CPX *vr, int ldvr, CPX *work, int lwork, double *rwork, int *info) {
    fortran_name(zggev, ZGGEV)(&jobvl, &jobvr, &n, a, &lda, b, &ldb, alpha, beta, vl, &ldvl, vr, &ldvr, work, &lwork, rwork, info);
}

/************************************************************************************************/

inline void c_zgeev(char jobvl, char jobvr, int n, CPX *a, int lda, CPX *w, CPX *vl, int ldvl, CPX *vr, int ldvr, CPX *work,
...
inline void c_zhetrs(char uplo, int n, int nrhs, CPX *a, int lda, int *ipiv, CPX *b, int ldb, int *info) {
    fortran_name(zhetrs, ZHETRS)(&uplo, &n, &nrhs, a, &lda, ipiv, b, &ldb, info);
}

/************************************************************************************************/

inline void c_dsysv(char uplo, int n, int nrhs, double *a, int lda, int *ipiv, double *b, int ldb, double *work, int lwork,
                    int *info) {
...
inline void c_dsytrs(char uplo, int n, int nrhs, double *a, int lda, int *ipiv, double *b, int ldb, int *info) {
    fortran_name(dsytrs, DSYTRS)(&uplo, &n, &nrhs, a, &lda, ipiv, b, &ldb, info);
}

/************************************************************************************************/

inline void c_dstebz(char *range, char *order, int *iter, double *vl, double *vu, int *il, int *iu, double *abstol, double *diag,
                     double *offd, int *neval, int *nsplit, double *eval, int *iblock, int *isplit, double *work, int *iwork,
                     int *info) {
    fortran_name(dstebz, DSTEBZ)(range, order, iter, vl, vu, il, iu, abstol, diag, offd, neval, nsplit, eval, iblock, isplit, work,
                                 iwork, info);
}

/************************************************************************************************/

inline void c_zlarnv(int *idist, int *iseed, int n, CPX *x) { fortran_name(zlarnv, ZLARNV)(idist, iseed, &n, x); }

/************************************************************************************************/

inline void c_dgesdd(char jobz, int m, int n, double *a, int lda, double *s, double *u, int ldu, double *vt, int ldvt, double *work,
...
inline void c_zgesdd(char jobz, int m, int n, CPX *a, int lda, double *s, CPX *u, int ldu, CPX *vt, int ldvt, CPX *work, int lwork,
...
template <typename T>
inline void copy_csr_to_device(int size, int n_nonzeros, int *hedge_i, int *hindex_j, T *hnnz, int *dedge_i, int *dindex_j,
                               T *dnnz);

template <>
inline void copy_csr_to_device(int size, int n_nonzeros, int *hedge_i, int *hindex_j, double *hnnz, int *dedge_i, int *dindex_j,
                               double *dnnz) {
    d_copy_csr_to_device(size, n_nonzeros, hedge_i, hindex_j, hnnz, dedge_i, dindex_j, dnnz);
}

template <>
inline void copy_csr_to_device(int size, int n_nonzeros, int *hedge_i, int *hindex_j, CPX *hnnz, int *dedge_i, int *dindex_j,
                               CPX *dnnz) {
...
template <typename T>
inline void csr_mult_f(void *handle, int m, int n, int k, int n_nonzeros, int *Aedge_i, int *Aindex_j, T *Annz, T alpha, T *B,
                       T beta, T *C);

template <>
inline void csr_mult_f(void *handle, int m, int n, int k, int n_nonzeros, int *Aedge_i, int *Aindex_j, double *Annz, double alpha,
                       double *B, double beta, double *C) {
    d_csr_mult_f(handle, m, n, k, n_nonzeros, Aedge_i, Aindex_j, Annz, alpha, B, beta, C);
}

template <>
inline void csr_mult_f(void *handle, int m, int n, int k, int n_nonzeros, int *Aedge_i, int *Aindex_j, CPX *Annz, CPX alpha, CPX *B,
                       CPX beta, CPX *C) {
...
template <typename T>
inline void extract_diag_on_dev(T *D, int *edge_i, int *index_j, T *nnz, int NR, int imin, int imax, int shift, int findx,
                                cudaStream_t stream);

template <>
inline void extract_diag_on_dev(double *D, int *edge_i, int *index_j, double *nnz, int NR, int imin, int imax, int shift, int findx,
                                cudaStream_t stream) {
    d_extract_diag_on_dev(D, edge_i, index_j, nnz, NR, imin, imax, shift, findx, stream);
}

template <>
inline void extract_diag_on_dev(CPX *D, int *edge_i, int *index_j, CPX *nnz, int NR, int imin, int imax, int shift, int findx,
                                cudaStream_t stream) {
...
template <typename T>
inline void extract_not_diag_on_dev(T *D, int *edge_i, int *index_j, T *nnz, int NR, int imin, int imax, int jmin, int side,
                                    int shift, int findx, cudaStream_t stream);

template <>
inline void extract_not_diag_on_dev(double *D, int *edge_i, int *index_j, double *nnz, int NR, int imin, int imax, int jmin,
                                    int side, int shift, int findx, cudaStream_t stream) {
    d_extract_not_diag_on_dev(D, edge_i, index_j, nnz, NR, imin, imax, jmin, side, shift, findx, stream);
}

template <>
inline void extract_not_diag_on_dev(CPX *D, int *edge_i, int *index_j, CPX *nnz, int NR, int imin, int imax, int jmin, int side,
                                    int shift, int findx, cudaStream_t stream) {
...
template <typename T>
inline void fill_dev(T *x, const T value, size_t N, cudaStream_t stream = NULL);

template <>
inline void fill_dev(double *x, const double value, size_t N, cudaStream_t stream) {
    d_fill_on_dev(x, value, N, stream);
}

template <>
inline void fill_dev(CPX *x, const CPX value, size_t N, cudaStream_t stream) {
    z_fill_on_dev(x, value, N, stream);
}
...
template <typename T>
inline void init_supernode_dev(T *M, size_t *ia, size_t *ja, T *a, size_t supernode, size_t supernode_nnz, size_t supernode_offset,
                               size_t ns, size_t nt, size_t nd, cudaStream_t stream = NULL);

template <>
inline void init_supernode_dev(double *M, size_t *ia, size_t *ja, double *a, size_t supernode, size_t supernode_nnz,
                               size_t supernode_offset, size_t ns, size_t nt, size_t nd, cudaStream_t stream) {
    d_init_supernode_on_dev(M, ia, ja, a, supernode, supernode_nnz, supernode_offset, ns, nt, nd, stream);
}

template <>
inline void init_supernode_dev(CPX *M, size_t *ia, size_t *ja, CPX *a, size_t supernode, size_t supernode_nnz,
                               size_t supernode_offset, size_t ns, size_t nt, size_t nd, cudaStream_t stream) {
    z_init_supernode_on_dev(M, ia, ja, a, supernode, supernode_nnz, supernode_offset, ns, nt, nd, stream);
}
