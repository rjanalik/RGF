...
void memcpy_to_host(void *, void *, size_t, cudaStream_t stream = NULL);
/**
 * @}
 */
...
void dsum_on_dev(int n, double *x, int incx, double *result,
                 magma_queue_t queue);
void zsum_on_dev(int n, CPX *x, int incx, CPX *result, magma_queue_t queue);
void d_copy_csr_to_device(int, int, int *, int *, double *, int *, int *,
                          double *);
...
void z_csr_mult_f(void *, int, int, int, int, int *, int *, CPX *, CPX, CPX *,
                  CPX, CPX *);
void z_csr_mult_fo(void *, int, int, int, int, int *, int *, CPX *, CPX, CPX *,
                   CPX, CPX *);
...
void d_extract_diag_on_dev(double *, int *, int *, double *, int, int, int, int,
                           int, cudaStream_t);
void d_extract_not_diag_on_dev(double *, int *, int *, double *, int, int, int,
...
void d_indexed_copy_offset_on_dev(double *src, double *dst, size_t *index,
                                  size_t N, size_t offset);
void z_indexed_copy_offset_on_dev(CPX *src, CPX *dst, size_t *index, size_t N,
                                  size_t offset);
...
void z_fill_on_dev(CPX *x, const CPX value, size_t N,
                   cudaStream_t stream = NULL);
void d_init_block_matrix_on_dev(double *M, size_t *ia, size_t *ja, double *a,
                                size_t nnz, size_t ns, size_t nt, size_t nd);
void z_init_block_matrix_on_dev(CPX *M, size_t *ia, size_t *ja, CPX *a,
                                size_t nnz, size_t ns, size_t nt, size_t nd);
void d_init_supernode_on_dev(double *M, size_t *ia, size_t *ja, double *a,
                             size_t supernode, size_t supernode_nnz,
                             size_t supernode_offset, size_t ns, size_t nt,
                             size_t nd, cudaStream_t stream = NULL);
void z_init_supernode_on_dev(CPX *M, size_t *ia, size_t *ja, CPX *a,
                             size_t supernode, size_t supernode_nnz,
                             size_t supernode_offset, size_t ns, size_t nt,
                             size_t nd, cudaStream_t stream = NULL);
}
